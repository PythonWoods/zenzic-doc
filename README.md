...
| `just verify` | Recommended final local check (full gate) | Runs all pre-commit hooks + `build` + codes parity + strict Zenzic docs audit |
...
**Discovered in:** current release release audit (D090 "The i18n Lockdown").
