...
[Saga I](/blog/hardening-the-documentation-pipeline) | [Saga II](/blog/docs-pipeline-security-risk-obsidian-bastion) | [Saga III](/blog/ai-driven-siege-shield-postmortem) | [Saga IV](/blog/beyond-the-siege-zenzic-v070-new-standard) | **Saga V** | [Saga VI](/blog/governance-of-glass)
...
existence — and stop there. Zenzic operates on a different axis entirely: **trust**.
...
| Design Dimension | Generic Link Checkers | Zenzic Obsidian Guard |
| :--- | :--- | :--- |
...
The choice of which tool to run depends on which question you need to answer. If the
question is *"do these links resolve?"*, a link checker is the right tool. If the
question is *"is this documentation safe, complete, and navigable?"*, the trust model
matters — and Zero-Trust is the only honest answer when documentation is produced by
teams, contributors, or automated agents you do not fully control.
