...
v0.8.0 Basalt is not a cosmetic release. It is a contract release: explicit tier boundaries,
frozen security guarantees, and a machine-consumable route surface for external tools.

{/* truncate */}

## The SSG Illusion: "Why use Zenzic if my SSG already checks broken links?"

The objection is valid. The conclusion is wrong.
