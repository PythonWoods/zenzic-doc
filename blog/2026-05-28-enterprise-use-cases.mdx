...
If the translation backlog is substantial, set `parity_strict = false` initially and use `governance.directory_policies` to suppress Z602 for specific locale directories that are still under active translation work:
