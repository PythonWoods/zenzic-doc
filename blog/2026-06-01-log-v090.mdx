---
slug: log-v090
title: "Release v0.9.0: The Deterministic Telemetry"
sidebar_label: "Release v0.9.0"
authors: [pythonwoods]
tags: [release, milestone, engineering-logs]
date: 2026-06-01T10:00:00
description: >-
  v0.9.0 introduces deterministic telemetry as a first-class release contract:
  flat-cost DQS semantics, adapter API cleanup, native badge freshness checks,
  and landing/topology restructuring.
...
- topology-facing docs now follow the same deterministic signal boundaries used
