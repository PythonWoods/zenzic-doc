...
title: "Zenzic v0.10.0: Native GitHub Annotations and Progressive Adoption"
authors: [pythonwoods]
...
Zenzic v0.10.0 introduces two architectural changes designed strictly for the CI/CD pipeline: **Native GitHub Annotations** and **Destructive Rule Filtering**.

These features are not aesthetic. They are built to solve two specific operational bottlenecks: context switching during Pull Request reviews and the high friction of adopting static analysis in legacy documentation repositories.
