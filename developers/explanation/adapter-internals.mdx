...
> For concrete code comparisons showing how these strategies are implemented in Python, see [Writing an Adapter — Concrete Examples](../how-to/implement-adapter.mdx#concrete-implementation-examples-docusaurus-vs-standalone).
> 
> For the abstract class definition and protocol signatures, see [API Reference — `BaseAdapter`](../reference/adapter-api.mdx#baseadapter-interface).
