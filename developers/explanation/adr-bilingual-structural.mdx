...
> For step-by-step CLI commands and workflow details on how to perform the symmetry check, see the [Bilingual Parity contribution checklist in the Release Protocol](../how-to/release-governance-protocol.mdx#bilingual-parity-symmetry-check).
