...
Two independent fixes were applied to `docusaurus.config.ts`. For step-by-step instructions on implementing these configurations, see [Release & Governance Protocol — Docusaurus Configuration Repairs](../how-to/release-governance-protocol.mdx#10-docusaurus-configuration-repairs).
