...
These ADRs were established before public publication. They define the
philosophical and technical foundations on which all subsequent decisions rest.

| ADR | Title | Sprint |
|-----|-------|--------|
| [ADR 001](./adr-lint-source.mdx) | Lint the Source, Not the Build | Genesis |
| ADR 002 | Zero Subprocesses Policy | Genesis *(Maintainer Only)* |

---

## Core Architecture Decisions

These ADRs document the structural decisions made during active development.
...
| [ADR 011](./adr-cross-instance-allowlist.mdx) | Cross-Instance Absolute Path Allowlist | Adopted |
