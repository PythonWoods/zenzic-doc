...
## Closed in v0.7.0 — Operation Obsidian Stress {/* zenzic:ignore Z601 */}

:::info[What was the Operation?]

Before the v0.7.0 release, four AI agents were instructed to break Zenzic's credential scanner
...
**Identified by:** AI Red Team agent "Alpha" during Operation Obsidian Stress {/* zenzic:ignore Z601 */}
...
**Identified by:** AI Red Team agent "Bravo" during Operation Obsidian Stress {/* zenzic:ignore Z601 */}
**Component:** `core/credentials.py`, `scan_lines_with_lookback()`
...
**Identified by:** AI Red Team agent "Charlie" during Operation Obsidian Stress {/* zenzic:ignore Z601 */}
**Component:** `core/credentials.py`
**Description:**  The credential scanner scanned raw Markdown bytes. Agent Charlie used HTML entity
...
**Identified by:** AI Red Team agent "Delta" during Operation Obsidian Stress {/* zenzic:ignore Z601 */}
