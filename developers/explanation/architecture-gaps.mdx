...
The Z204 Privacy Gate and the Z905 Brand Obsolescence Guard form a two-layer architecture:
...
- **Z905** (`obsolete_names` in `zenzic.toml`): exit 1, suppressible with `zenzic:ignore Z905`.
