...
## Closed in v0.7.0 — Obsidian Stress Test {/* zenzic:ignore Z601 */}

:::info[What was the Obsidian Stress Test?]

Before the v0.7.0 release, a structured adversarial stress-test suite was executed against Zenzic's credential scanner
...
**Identified during:** Obsidian Stress Test (v0.7.0 pre-release) {/* zenzic:ignore Z601 */}
