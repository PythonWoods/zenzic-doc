...
Removing Zenzic from a project is designed to be trivial and leave no residual lock-in. For step-by-step instructions on decommissioning, see the [Install & First Run guide — Decommissioning Zenzic](/docs/how-to/install#decommissioning-zenzic).
