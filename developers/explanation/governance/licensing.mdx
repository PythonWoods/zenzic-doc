...
For step-by-step instructions on adding dependencies, see [Release and Governance Protocol — Adding a Dependency](../../how-to/release-governance-protocol.mdx#adding-a-dependency).
