...
| `release-contracts` recipe | Drift guard | Rejects PyPI fallback patterns in gate paths |
...
If verification reports missing core path, treat it as setup misconfiguration,
not as a quality warning to suppress.
