...
For the step-by-step setup procedure on how to configure your local workspace and run the verification suite, see the [Contributor Runbook in the Release Protocol](../how-to/release-governance-protocol.mdx#contributor-runbook-local-setup).
