...
> *"Zenzic is a sentinel in your pipeline, not a chain. The ability to remove it
...
To ensure the integrity of the Safe Harbor, Zenzic's audit core is strictly read-only.
