...
**Status:** Deferred to future release cycle
...
3. **YAGNI signal absent.** No real-world reports of stale allowlist
   entries exist yet. The initial public Technical Debt Ledger is the first release that has the feature at
...
*(none yet — the initial public Technical Debt Ledger is the first release with a published record.)*
