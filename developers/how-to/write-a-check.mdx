...
All checks must respect the Core Laws governing the scanner. Before writing a check, ensure you are familiar with the invariants detailed in the [Core Laws of the Scanner](../explanation/core-laws.mdx).
