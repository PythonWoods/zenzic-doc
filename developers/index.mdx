...
- [Governance Playbook: Troubleshooting and Invariants](how-to/release-governance-protocol.mdx)
...
- [Writing Plugin Rules](how-to/write-plugin.mdx) — implement `BaseRule` subclasses, register
...
- [Example Projects](tutorials/adapter-examples.mdx) — four self-contained runnable fixtures that
