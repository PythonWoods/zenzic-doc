...
| `_check.py` | `check_app` Typer sub-app + seven `check *` commands; private helpers re-exported from `_governance.py`, `_target_resolver.py`, and `_command_setup.py` (Phase 82) |
