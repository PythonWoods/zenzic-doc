...
For the design rationale behind UI state sharing, see [ADR 004 — Unified Console State](../explanation/adr-decentralized-cli.mdx#4-unified-console-state-visual-state-manager).
...
For step-by-step instructions on how to add commands or new sub-apps to the CLI, see [Writing a New Check — CLI Wiring](../how-to/write-a-check.mdx#cli-wiring).
