...
These rules exist because the v0.5.0a3 security review (2026-04-04) demonstrated that four
individually reasonable design choices — each correct in isolation — composed into four
distinct attack vectors. See `docs/internal/security/shattered_mirror_report.md` for the
full post-mortem.
