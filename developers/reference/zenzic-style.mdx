...
For the detailed architectural rationale behind this directive, see [MDX Asset Componentization Rationale](../explanation/mdx-asset-rationale.mdx).

For step-by-step instructions on converting static SVGs to TSX components, see [Release and Governance Protocol — Converting Static SVGs to React Components](../how-to/release-governance-protocol.mdx#11-converting-static-svgs-to-react-components).
