...
**Data:** 2026-04-27 (sprint v0.8.x, CEO 051, commit `3188387`)
...
Due fix indipendenti sono stati applicati a `docusaurus.config.ts`. Per istruzioni passo-passo sull'implementazione di queste configurazioni, vedere le versioni storiche del Protocollo di Governance e Rilascio.
