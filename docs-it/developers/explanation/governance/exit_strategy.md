...
La rimozione di Zenzic da un progetto è progettata per essere banale e non lasciare vincoli residui. Per istruzioni passo-passo sulla dismissione, vedere la [Guida all'installazione e primo avvio — Dismissione di Zenzic](../../../how-to/install.md#dismissione-di-zenzic).
