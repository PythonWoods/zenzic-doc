...
Dopo l'installazione, esegui `zenzic inspect capabilities` per confermare che la regola
venga scoperta:
...
effetto — questo è il comportamento intenzionale del **Exclusion Zone**: sai sempre
...
!!! info "Passaggi Successivi"
     Collega la regola dal codice al flusso Zenzic in produzione:
     ...
     2. Valida la regola in semantica pipeline strict:
         ...
         Per i controlli di run, vedi [Comandi CLI: Flag globali](../../reference/cli.md#global-flags).
