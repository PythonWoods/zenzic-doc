...
Per il razionale di design dietro la condivisione dello stato dell'interfaccia utente, vedere [ADR 004 — Stato della Console Unificato](../explanation/adr-decentralized-cli.md#4-stato-della-console-unificato-visual-state-manager).
...
Per istruzioni passo-passo su come aggiungere comandi o nuove sub-app alla CLI, vedere [Scrivere un Nuovo Check — Cablaggio CLI](../how-to/write-a-check.md#cablaggio-cli).
