...
Zenzic è molto più di un linter. È un **Sistema di Conoscenza Sovrano** — un ecosistema
in cui logica, intenzione ed esecuzione sono permanentemente sincronizzati. Per garantire un vero
[Exclusion Zone](./privacy-gate.md), Zenzic è organizzato in una Trinità dell'Integrità: tre
...
| **Adapter Protocol** | Traduce la configurazione specifica del motore (MkDocs, Zensical, Standalone) in un modello di analisi unificato. |
...
Il corpus degli ADR garantisce che la filosofia del Exclusion Zone rimanga stabile nel tempo,
...
La Action espone il [contratto dei codici di uscita](../reference/finding-codes.md) del Core
...
!!! info Il Exclusion Zone è un Sistema di Conoscenza Sovrano
