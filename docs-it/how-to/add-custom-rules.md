...
> Per il riferimento completo ai campi, la matrice di severity e il formato dell'output, vedi [Configuration Reference — `[[custom_rules]]`](../reference/configuration-reference.md#custom-rules).
