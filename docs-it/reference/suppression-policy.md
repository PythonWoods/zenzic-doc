...
"docs/explanation/registry.md" = ["Z601"]  # registro SSOT dei codename
```
...
- [Gestire il Technical Debt](../how-to/handle-technical-debt.md) — Guida passo-passo per verificare e ridurre il suppression debt.
- [Algoritmo di Scoring](./scoring-algorithm.md) — Come il suppression debt interagisce con il quality score completo.
- [Riferimento Codici di Finding](./finding-codes.md) — Catalogo completo di tutti i codici Zxxx con passaggi di rimedio.
- [Riferimento Configurazione](./configuration-reference.md) — Riferimento completo della sezione `governance`.
