...
sidebar_label: "DQS Mathematical Model"
authors: [pythonwoods]
...
- [Scoring Algorithm Reference](../user-manual/reference/scoring-algorithm.md) — Full formula derivation and penalty table
- [Suppression Policy](../user-manual/reference/suppression-policy.md) — Three suppression levels and the `--audit` override
- [Finding Codes](../user-manual/reference/finding-codes.md) — Full Zxxx code encyclopedia with remediation steps
