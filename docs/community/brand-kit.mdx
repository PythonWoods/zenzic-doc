...
The `backdrop-blur` layer that sits beneath every `SentinelOutput` panel acts as an additional dampener, smearing the border glow and preventing the "neon" effect on dark surfaces.
