...
Third-party adapters can extend this to any other engine. See the [Engines guide](../guides/engines.mdx)
for details.
...
For the full setup with dynamic badges and regression detection, see the [CI/CD guide](../guides/ci-cd.mdx).
