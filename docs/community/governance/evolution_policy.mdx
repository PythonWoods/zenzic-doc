...
Safe Harbor. A Zenzic without Pillar II (Zero Subprocesses) is not a faster Zenzic
...
3. **A formal [ADR](https://github.com/PythonWoods/zenzic/blob/main/.github/copilot-instructions.md)**
   added to the Obsidian Ledger
4. **An [Adversarial AI session](./adversarial_ai) (Type A)** against the proposed
...
has read the Obsidian Ledger once — it is not a candidate for the Evolution Policy.
...
- Requires a logged emergency ADR in the Obsidian Ledger with: invariant suspended,
