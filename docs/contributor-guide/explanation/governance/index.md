...
| Document | Purpose |
| :--- | :--- |
| [The Sovereignty Oath](exit_strategy.md) | Proof that Zenzic is a tool, not a master. Zero Residue. Reversible in 30 seconds. |
| [Evolution Policy](evolution_policy.md) | The formal process for evolving — or protecting — the Three Pillars. |
| [License Compliance](licensing.md) | Apache-2.0 + REUSE 3.3. Every file carries the cryptographic signature of its license. |
...
| :--- | :--- | :--- |
| **Liberty** | [The Sovereignty Oath](exit_strategy.md) | Removed in 30 seconds. Zero residue. Core is read-only. |
| **Duration** | [Evolution Policy](evolution_policy.md) | No Pillar changes without a public constitutional process. |
