...
- <Icon name="play" /> &nbsp; **User Guide**
    ...
    [<Icon name="arrow-right" /> Explore the Guide](../../user-manual/how-to/install.md)
```
...
2. It is referenced by a cross-page link (`[text](../../developers/reference/page.md#anchor)`).
...
For step-by-step instructions on converting static SVGs to TSX components, see [Release and Governance Protocol — Converting Static SVGs to React Components](../how-to/release-governance-protocol.md#11-converting-static-svgs-to-react-components).
