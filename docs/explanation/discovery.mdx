...
Multi-Root Discovery (EPOCH 7a) solved **VSM Blindness** for physical files outside
`docs/`. EPOCH 7b extends the guarantee to **engine-generated pages**: Docusaurus renders
...
EPOCH 7b ships a first-class CLI command that exposes the VSM to external consumers:
