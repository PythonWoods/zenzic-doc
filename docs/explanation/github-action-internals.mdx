...
description: "How zenzic-action enforces security: Blood Sentinel Protocol, Exit Code Contract, Root-First Sentinel cascade, and Sovereign Intent."
---
...
| [Architecture](./architecture) | Zenzic Core two-pass pipeline, Shield middleware, adapter protocol |
| [ADR Vault](https://zenzic.dev/developers/explanation/adr-vault) | Architectural decisions behind the exit code contract and Blood Sentinel |
