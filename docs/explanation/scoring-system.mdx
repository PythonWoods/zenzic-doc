...
The Quality Score is the operational proof of Zenzic's [Three Pillars](why-zenzic.mdx#defence-trinity):
...
- [Suppression Policy](../reference/suppression-policy.mdx) — how suppressed findings affect the Quality Score
