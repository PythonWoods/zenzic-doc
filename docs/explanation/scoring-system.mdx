...
> For the full per-code penalty lookup table, see [Scoring Algorithm — Penalty Reference Table](../reference/scoring-algorithm.mdx#penalty-table).
...
> For CLI command reference and CI integration patterns, see [Handle Technical Debt](../how-to/handle-technical-debt.mdx) and [Scoring Design](./scoring-design.mdx).
