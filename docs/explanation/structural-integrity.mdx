...
| [`Z106`](../reference/finding-codes.mdx#z106) | `CIRCULAR_LINK` | Circular link cycles — structural telemetry, not a defect (see [architectural rationale](../reference/finding-codes.mdx#z106)) |
...
| [`Z106`](../reference/finding-codes.mdx#z106) | `CIRCULAR_LINK` | Link cycles — structural telemetry; documentation forms an interconnected Knowledge Graph where cycles are expected (see [architectural rationale](../reference/finding-codes.mdx#z106)) |
