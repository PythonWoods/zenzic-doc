...
Exit codes are preserved in JSON mode: exit 1 on errors, exit 2 on Shield breaches,
...
> For the full badge copy-paste reference, see [Official Badges](../usage/badges.mdx).
