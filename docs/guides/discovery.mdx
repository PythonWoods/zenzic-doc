...
## Porto Sicuro / Safe Harbor Philosophy {#safe-harbor}

The Layered Exclusion model implements the **Porto Sicuro** (Safe Harbor) principle: Zenzic creates a protected scanning environment where the file set is deterministic, reproducible, and fully controlled by the project maintainer.
