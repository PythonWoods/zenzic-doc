...
See: [Architecture -- Adapter Protocol](../internals/architecture-overview#adapter-protocol)
...
See: [Discovery & Exclusion](./discovery)

---

### Porto Sicuro / Safe Harbor {#porto-sicuro}
...
See: [Architecture -- Two-Pass Pipeline](../internals/architecture-overview#two-pass-pipeline)
