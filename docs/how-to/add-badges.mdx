...
Place the `passing` URL in your README. If this step fails in CI, manually swap the badge to `failing` — or automate it via [dynamic-badges-action](https://github.com/Schneegans/dynamic-badges-action) (see [CI/CD Integration](./configure-ci-cd.mdx)).
