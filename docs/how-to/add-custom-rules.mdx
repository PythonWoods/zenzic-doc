...
> For the full field reference, severity matrix, and output format, see [Configuration Reference — `[[custom_rules]]`](../reference/configuration-reference.mdx#custom-rules).
