...
This page is a troubleshooting guide for the most common configuration problems. For the full configuration model — file precedence, field definitions, and defaults — see [Configuration Reference](../reference/configuration-reference.mdx).
