...
Each adapter shields its engine configuration file from the unused-assets check (Z903). You do
...
See [Writing an Adapter](../community/developers/how-to/implement-adapter.mdx) for the full protocol.
