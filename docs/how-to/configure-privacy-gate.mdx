...
for patterns that require regex matching — see the [Configuration Reference](../reference/configuration-reference.mdx)
...
- [Z204 example](https://github.com/PythonWoods/zenzic/tree/main/examples/rules/z204-privacy-gate) — runnable demonstration
