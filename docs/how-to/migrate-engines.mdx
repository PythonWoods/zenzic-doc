...
> For the architectural rationale behind this approach — why Zenzic lints the source and not the build, how the MkDocsAdapter preserves the structural contract, and how i18n is validated independently of rendering — see [Engine Migration Design](../explanation/engine-migration-design.mdx).
