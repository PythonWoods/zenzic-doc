...
For a concrete baseline, use the Z-code gallery fixture `examples/z101-broken-links/`, which isolates
link integrity violations to show how MkDocs nav patterns interact with the Zenzic link checker.
