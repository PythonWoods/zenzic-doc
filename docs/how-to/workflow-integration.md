...
**NPM/Node ecosystem (Zensical/MkDocs)**


If you manage your documentation via npm scripts, gate the build command in `package.json`:
...
`npm run build` now runs Zenzic first. If any finding is detected, the build
