...
<ZenzicTerminal title="zenzic check all">
<div className="flex gap-2 items-baseline"><span className="text-rose-500">✘</span><span className="bg-rose-500/10 text-rose-400 px-1 rounded-sm text-[11px]">[Z111]</span><span className="text-zinc-300">docs/blog/tags/python/: Virtual route not mapped to any source file</span></div>
