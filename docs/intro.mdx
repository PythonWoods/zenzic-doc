...
This adds `mkdocs>=1.6.1` as a dependency and enables the `zenzic.integrations.mkdocs` entry point. See the [Ecosystem overview](./ecosystem/overview) for the full Adapter vs. Integration model.
