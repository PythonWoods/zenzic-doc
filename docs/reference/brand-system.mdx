...
description: "Palette contract, semantic tokens, and React component styling rules for Zenzic Docs."
---
...
:::danger[Policy Gate]
UI pull requests are rejected if JSX/TSX or local CSS introduces hardcoded color literals.
...
1. Explain policy and token mapping in MDX (this page).
