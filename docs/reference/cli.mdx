...
```bash
zenzic inspect capabilities   # Show all built-in scanners and registered plugin rules
```
...
┌──────────────┬───────────────────┬──────────────────────────────────────┬──────┐
│ Codes        │ Scanner           │ Capability                           │ Exit │
├──────────────┼───────────────────┼──────────────────────────────────────┼──────┤
│ Z201         │ The Shield        │ Credential & security detection      │ 2 ⚠  │
│ Z202–203     │ Blood Sentinel    │ Path-traversal & jailbreak detection │ 3 ⚠  │
│ Z101–106     │ Link Validator    │ Broken links & anchor resolution     │ 1    │
│ …            │ …                 │ …                                    │ …    │
└──────────────┴───────────────────┴──────────────────────────────────────┴──────┘
⚠  Exit 2 and Exit 3 are non-suppressible — --exit-zero has no effect on Shield or Blood Sentinel.
