...
zenzic check all --ci               # CI shorthand: sets --strict and --format github-annotations
...
`--ci` is a convenience shorthand designed specifically for GitHub Actions pipelines. It forces two behaviors simultaneously:
