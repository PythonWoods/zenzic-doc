...
- Inline suppressions (`zenzic-ignore` / `zenzic:ignore`) are ignored.
...
### Governance-Ready Blueprint (v0.8.0)
...
The global file is not an empty shell: it is a Basalt blueprint with didactic
...
You should immediately see your first Sentinel Seal.
...
<SentinelOutput status="inspect" exitCode={0} />
