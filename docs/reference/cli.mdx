...
`NO_COLOR` conforms to the [no-color.org](https://no-color.org/) standard convention.
...
Each act declares its expected outcome. After execution, the Obsidian Seal reports
