...
Every active suppression is an acknowledged assumption of responsibility. Suppressions are allowance-based: up to `suppression_cap`, they are governance-authorized and do not reduce the score. Only excess suppressions generate debt.
