...
:::note Z106 is informational only
Z106 is still emitted as a diagnostic for circular link cycles, but it is excluded from the penalty table and does not contribute to any DQS bucket.
:::
