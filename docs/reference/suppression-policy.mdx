...
blog/2026-05-24-log-v080.mdx:1 [Z601] [POLICY_EXEMPTION] Brand obsolescence: 'Basalt'
```
...
- [Scoring System](../explanation/scoring-system.mdx) — How suppressed findings affect the Quality Score.
