...
| :--- | :--- | :---: | :--- |
| `version` | `0.7.1` | No | Zenzic version to install (`latest` or an exact pin like `0.7.1`). Pin to a specific release for reproducible CI. |
...
The suppression debt is included in the score used for comparison. A PR that adds suppressions to hide findings will show a lower score.
