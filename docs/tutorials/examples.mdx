...
description: A guided index of the Zenzic reference projects — from zero-config Standalone Mode to VCS-aware, MkDocs integration, Docusaurus adapter, and Shield security lab.
---
...
Shield, and Blood Sentinel coverage:
