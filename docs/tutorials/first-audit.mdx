...
**The Shield (Obsidian Seal)** — now run act 0:

```bash
uvx zenzic lab 0
```

You'll see the Obsidian Seal: every check green, exit 0. The contrast is the lesson —
...
path traversal, and the Obsidian Seal. Zero install. Zero config. Pure experience.
...
A clean run looks like this — the **Obsidian Seal**:
