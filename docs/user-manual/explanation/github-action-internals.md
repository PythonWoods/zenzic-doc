...
For day-to-day usage (copy-paste YAML, input reference), see the [CI/CD Integration guide](../how-to/configure-ci-cd.md) and the [action README](https://github.com/PythonWoods/zenzic-action).
...
| [CI/CD Integration](../how-to/configure-ci-cd.md) | Workflow recipes, SARIF badge, score badge |
| [Architecture](architecture.md) | Zenzic Core two-pass pipeline, credential scanner middleware, adapter protocol |
