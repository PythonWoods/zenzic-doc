...
See: [Checks Reference -- Path Traversal Guard](checks.md#path-traversal-guard)
...
See: [Discovery & Exclusion](../explanation/discovery.md)
...
See: [Architecture -- Three-Phase Pipeline](../explanation/architecture.md#three-phase-pipeline)
