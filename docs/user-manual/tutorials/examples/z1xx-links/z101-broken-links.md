...
11
❱
- [Getting Started](../../../../tutorials/examples/z1xx-links/missing.md) — this file does not exist → **Z101**
│ ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
12│ - [Setup Guide](../../../../tutorials/examples/z1xx-links/guide/setup.md) — this directory does not exist →
**Z101**
13│
docs/index.md:12:2
✘
...
10│
11│ - [Getting Started](../../../../tutorials/examples/z1xx-links/missing.md) — this file does not exist → **Z101**
12
❱
- [Setup Guide](../../../../tutorials/examples/z1xx-links/guide/setup.md) — this directory does not exist →
**Z101**
│ ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
13│
...
| :--: | :--- | :----- | :-----: |
| 7    | `[Getting Started](../../../../tutorials/examples/z1xx-links/missing.md)` | `missing.md` | ✘ |
| 8    | `[Setup Guide](../../../../tutorials/examples/z1xx-links/guide/setup.md)` | `guide/setup.md` | ✘ |
...
- [z102 — Anchor Missing](z102-anchor-missing.md) — the fragment-level variant of link integrity:
  the target file exists, but the heading anchor does not.
- [z103 — Orphan Link](z103-orphan-link.md) — link targets that exist on disk but are absent from
  the site navigation (zensical engine required).
- [Checks Reference — Z101](../../../reference/checks.md) — full rule specification.
