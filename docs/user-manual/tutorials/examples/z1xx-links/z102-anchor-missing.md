...
11
❱
- [Nonexistent Section](../../../../tutorials/examples/z1xx-links/guide.md#nonexistent-section) — the fragment
...
'guide.md'
     ...
     9  │  ## Broken Anchor Reference
    10  │
    11  ❱  - [Nonexistent Section](../../../../tutorials/examples/z1xx-links/guide.md#nonexistent-section) — the fragment
`#nonexistent-section` is not defined i…
        │    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    12  │
    13  │  ## What Zenzic Reports
...
- [z101 — Broken Links](z101-broken-links.md) — the file-level variant: the target file itself does not exist.
- [z103 — Orphan Link](z103-orphan-link.md) — link targets that exist on disk but are absent from the site navigation.
