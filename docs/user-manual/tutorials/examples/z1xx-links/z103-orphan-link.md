...
16
❱
- [Guide](../../../../tutorials/examples/z1xx-links/guide.md) — `guide.md` exists on disk, but it is **not in
the nav** → **Z103**
│ ^^^^^^^^^^^^^^^^^
17│
...
nav entry:
    15  │
    16  ❱  - [Guide](../../../../tutorials/examples/z1xx-links/guide.md) — `guide.md` exists on disk, but it is **not in
the nav** → **Z103**
        │    ^^^^^^^^^^^^^^^^^
    17  │
    18  │  ## What Zenzic Reports
...
- [z102 — Anchor Missing](z102-anchor-missing.md) — the target file exists but the heading anchor does not.
- [z402 — Orphan Page](../z4xx-topology/z402-orphan-page.md) — the inverse: a page that is not in the nav and has no link pointing to it at all.
