...
11
❱
For the complete API specification, see the [API Reference](api/refer…
...
| :--: | :--- | :----- | :-----: |
| 11   | `[API Reference](../../../../tutorials/examples/z1xx-links/api/reference.md)` | `docs/api/reference.md` | ✘ |
...
```diff
- For the complete API specification, see the [API Reference](../../../../tutorials/examples/z1xx-links/api/reference.md).
+ For the complete API specification, see the [API Reference](../../../index.md).
```
...
- [Z101 — Broken Links](z101-broken-links.md) — routing-level link integrity.
- [Z102 — Anchor Missing](z102-anchor-missing.md) — fragment-level link integrity
  (file exists, heading anchor absent).
- [Checks Reference — Z104](../../../reference/checks.md) — full rule specification.
