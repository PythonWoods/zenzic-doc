...
`docusaurus.config.ts`, or `zensical.toml`) references a local asset file by
...
- [Z405 — Unused Assets](z405-unused-assets.md) — the inverse: a file exists but is never referenced.
- [Z402 — Orphan Page](z402-orphan-page.md) — page exists but is absent from navigation.
- [Checks Reference — Z404](../../../reference/checks.md) — full rule specification.
