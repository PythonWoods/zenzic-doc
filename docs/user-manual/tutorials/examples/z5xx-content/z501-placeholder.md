...
⚠
[Z501]
Found placeholder text matching pattern:
'(?i)placeholder'
...
⚠
[Z501]
Found placeholder text matching pattern: '(?i)todo'
8│ ## Installation
9│
10
❱
...
21
❱
docs/index.md:10:  Z501  PLACEHOLDER  placeholder pattern 'TODO:'
matched
│ ^^^^
...
22
❱
docs/index.md:16:  Z501  PLACEHOLDER  placeholder pattern 'Coming
soon!' matched
│
^^^^^^^^^^^
23│ ```
