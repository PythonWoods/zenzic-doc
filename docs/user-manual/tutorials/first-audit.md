...
See [Discovery & Exclusion — The Authority of Root](../explanation/discovery.md#root-authority) for the full rationale.
...
report and exits with a machine-readable code. For details on exit code definitions and security tiers, see the [Exit Code Contract](../reference/finding-codes.md#exit-code-contract).
...
[See the guide](../../tutorials/nonexistent-page.md)
```
...
- **Add a CI gate** — see [CI/CD Integration](../how-to/configure-ci-cd.md) for automated quality enforcement
...
- **Finding codes** — see the [Finding Codes reference](../reference/finding-codes.md) for the full
