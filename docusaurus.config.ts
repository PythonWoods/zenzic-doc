...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          type: 'html',
          position: 'left',
          value: '<span class="badge badge--secondary" style="margin-left: -0.5rem; font-size: 0.75rem;">v0.6.1rc1</span>',
        },
        {
          type: 'localeDropdown',
          position: 'right',
    ...
    footer: {
      style: 'dark',
      links: [],
      copyright: `© ${new Date().getFullYear()} PythonWoods. Zenzic v0.6.1rc1. Apache-2.0 License. · Python 3.11+ · Zero runtime dependencies`,
    },
    prism: {
