...
Due fix indipendenti sono stati applicati a `docusaurus.config.ts`. Per istruzioni passo-passo sull'implementazione di queste configurazioni, vedere [Protocollo di Governance e Rilascio — Ripristino della Configurazione Docusaurus](../how-to/release-governance-protocol.mdx#10-ripristino-della-configurazione-docusaurus).
