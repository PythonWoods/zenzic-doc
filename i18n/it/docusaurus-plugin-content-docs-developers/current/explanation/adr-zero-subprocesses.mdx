...
disabilitano. L'analisi basata sul sorgente e senza subprocess di Zenzic gira
interamente nel processo corrente — nessun processo figlio, nessuna
installazione di dipendenze, nessuna build parziale. Il costo dominante sulle
invocazioni a freddo è l'avvio dell'interprete Python; con bytecode cache caldo
l'overhead è trascurabile rispetto al ciclo di build SSG completo.
