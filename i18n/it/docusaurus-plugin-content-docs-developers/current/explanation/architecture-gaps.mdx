...
sidebar_position: 5
description: "Gap architetturali identificati e chiusi in v0.8.x, con elementi aperti pianificati per v0.8.x"
---
...
>
> Questa pagina traccia i gap chiusi e quelli ancora aperti. È un documento
> vivente, aggiornato ad ogni sprint.
...
Prima della pubblicazione, una suite strutturata di stress test avversariali è stata eseguita sul credential scanner di Zenzic utilizzando tecniche di bypass realistiche. La suite ha individuato quattro vettori di attacco reali. Tutti sono stati chiusi prima della pubblicazione.

:::

### ZRT-001 — Bypass per Normalizzazione Unicode (credential scanner)

**Identificato durante:** Integrity Stress Test
