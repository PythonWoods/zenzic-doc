...
## Chiusi in — Obsidian Stress Test {/* zenzic:ignore Z601 */}

:::info[Cos'è l'Obsidian Stress Test?]
...
**Identificato durante:** Obsidian Stress Test (pre-release current release) {/* zenzic:ignore Z601 */}
