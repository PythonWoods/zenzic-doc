...
## Chiusi in v0.7.0 — Operazione Obsidian Stress {/* zenzic:ignore Z601 */}

:::info[Cos'era l'Operazione?]

Prima del rilascio di v0.7.0, quattro agenti AI sono stati istruiti per violare
il credential scanner di Zenzic (scanner di credenziali) utilizzando tecniche di bypass
...
**Identificato da:** Agente AI "Alpha" durante l'Operazione Obsidian Stress {/* zenzic:ignore Z601 */}
...
**Identificato da:** Agente AI "Bravo" durante l'Operazione Obsidian Stress {/* zenzic:ignore Z601 */}
**Componente:** `core/credentials.py`, `scan_lines_with_lookback()`
...
**Identificato da:** Agente AI "Charlie" durante l'Operazione Obsidian Stress {/* zenzic:ignore Z601 */}
**Componente:** `core/credentials.py`
**Descrizione:** Lo credential scanner scansionava i byte Markdown grezzi. L'agente Charlie ha
...
**Identificato da:** Agente AI "Delta" durante l'Operazione Obsidian Stress {/* zenzic:ignore Z601 */}
