...
Il Privacy Gate Z204 e il Brand Obsolescence Guard Z905 formano un'architettura a due livelli:
...
- **Z905** (`obsolete_names` in `zenzic.toml`): exit 1, sopprimibile con `zenzic:ignore Z905`.
