...
## Chiusi in v0.7.0 — Obsidian Stress Test {/* zenzic:ignore Z601 */}

:::info[Cos'è l'Obsidian Stress Test?]

Prima del rilascio di v0.7.0, una suite strutturata di stress test avversariali è stata eseguita sul credential scanner di Zenzic utilizzando tecniche di bypass realistiche. La suite ha individuato quattro vettori di attacco reali. Tutti sono stati chiusi prima del rilascio stabile.

:::

### ZRT-001 — Bypass per Normalizzazione Unicode (credential scanner)

**Identificato durante:** Obsidian Stress Test (pre-release v0.7.0) {/* zenzic:ignore Z601 */}
