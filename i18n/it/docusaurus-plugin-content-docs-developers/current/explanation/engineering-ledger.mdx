...
sidebar_position: 6
description: "I tre pilastri architetturali di Zenzic current release — Zero Assunzioni, Senza Sottoprocessi, e Grafo Deterministico — spiegati come prove di forza."
---
...
Questa pagina è il manifesto tecnico dietro ogni decisione che rende Zenzic current release
abbastanza affidabile da essere chiamato un **Exclusion Zone**. Appartiene al quadrante
...
combinazioni dalla versione current release I test property-based (Hypothesis, profilo `ci`:
...
```python
# core/scorer.py — D092 Zenzic Penalty Scorer
...
| `2` | **Credential scanner — credenziale rilevata (Z201)** | ❌ **Mai** |
| `3` | **Path traversal guard — path traversal / fatale (Z202/Z203)** | ❌ **Mai** |
...
- [Architecture](./architecture-gaps) — gap aperti e roadmap current release
- [Riferimento ai Codici di Finding](/docs/reference/finding-codes) — il catalogo completo `Zxxx`
- [Exclusion Zone](/docs/explanation/privacy-gate) — la filosofia dietro l'ingegneria
