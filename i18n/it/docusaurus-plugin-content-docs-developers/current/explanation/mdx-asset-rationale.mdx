...
sidebar_label: "Razionale Asset MDX"
...
| **Illustrazioni README di GitHub** | Consentito (✓) | Renderizzato dal processore Markdown di GitHub al di fuori del contesto Docusaurus |
