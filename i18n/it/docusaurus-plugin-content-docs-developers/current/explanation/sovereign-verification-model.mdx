...
Per la procedura passo dopo passo su come configurare lo spazio di lavoro locale ed eseguire la suite di verifica, vedi il [Runbook per Contributor nel Protocollo di Rilascio](../how-to/release-governance-protocol.mdx#contributor-runbook-local-setup).
