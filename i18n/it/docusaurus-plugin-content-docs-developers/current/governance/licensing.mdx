...
> mantieni invariato il contenuto del documento e aggiungi un'esclusione temporanea
> in `.zenzic.toml` con un commento di review esplicito. Così non si maschera il
> drift dei contenuti e il guard resta utilizzabile su reti instabili.
