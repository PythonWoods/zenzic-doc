...
Tutti i check devono rispettare le leggi fondamentali (Core Laws) dello scanner. Prima di scrivere un check, assicurati di familiarizzare con gli invarianti dettagliati nelle [Leggi Fondamentali dello Scanner](../explanation/core-laws.mdx).
