...
Queste regole esistono perché la security review v0.5.0a3 (2026-04-04) ha dimostrato che quattro
scelte di design individualmente ragionevoli — ognuna corretta in isolamento — si sono composte
in quattro vettori di attacco distinti. Vedi `docs/internal/security/shattered_mirror_report.md`
