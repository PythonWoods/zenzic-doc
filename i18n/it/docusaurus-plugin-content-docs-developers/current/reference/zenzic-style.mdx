---
sidebar_label: "Guida di Stile Zenzic"
sidebar_position: 6
...
Per il razionale architetturale dettagliato dietro questa direttiva, vedere [Razionale della Componentizzazione degli Asset MDX](../explanation/mdx-asset-rationale.mdx).

Per istruzioni passo-passo sulla conversione di SVG statici in componenti TSX, vedere [Protocollo di Governance e Rilascio — Conversione di SVG Statici in Componenti React](../how-to/release-governance-protocol.mdx#11-conversione-di-svg-statici-in-componenti-react).
