...
Scaricalo dalla pagina [GitHub Releases](https://github.com/PythonWoods/zenzic/releases/latest). Dopo il rilascio,
l'URL diretto è:
`https://github.com/PythonWoods/zenzic/releases/latest/download/brand-kit.zip`
