...
Zenzic richiede Python 3.10 o superiore.

## Installazione e utilizzo

**Come si installa Zenzic?**

Il modo più diretto è usare `uvx` per eseguirlo direttamente senza installazione:
...
build (modalità Standalone). Gli adapter nativi per MkDocs e Zensical aggiungono la consapevolezza
...
**Cos'è il credential scanner (exit code 2)?**

Exit code `2` indica che il credential scanner ha rilevato un pattern che assomiglia a
...
**Cos'è il path traversal guard (exit code 3)?**
