...
| `VanillaAdapter` | `vanilla` | _(nessuno — ogni file è REACHABLE)_ |
...
- [Riferimento Architettura](../internals/architecture-overview) — Approfondimento sul Protocollo Adapter e il contratto `BaseAdapter`.
- [Discovery e Esclusione](../guides/discovery) — Come Zenzic scopre i file prima che l'Adapter venga consultato.
- [Riferimento Configurazione](../guides/configuration-reference) — Selezione engine in `[build_context]` e opzioni `zenzic.toml`.
