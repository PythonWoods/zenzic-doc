...
> Vedi [Integrazione CI/CD](../how-to/configure-ci-cd.mdx) per esempi di workflow.
...
> Vedi [Integrazione CI/CD](../how-to/configure-ci-cd.mdx) per workflow passo dopo passo corrispondenti a ogni scenario.
