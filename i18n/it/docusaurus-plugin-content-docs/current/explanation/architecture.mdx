...
Il `LayeredExclusionManager` e il cuore del sistema di esclusione a 4 livelli. I suoi interni sono documentati in dettaglio nella pagina [Discovery e Esclusione](./discovery).
