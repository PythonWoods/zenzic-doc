...
sidebar_position: 2
title: Architettura
description: Approfondimento tecnico sulla pipeline a due passate di Zenzic, il credential scanner, il protocollo Adapter, il Layered Exclusion Manager e il contratto dei codici di uscita.
---
...
Il motore principale di analisi opera come una **Pipeline a Due Passate** sull'insieme dei file di documentazione. Ogni passata ha una responsabilità distinta; la Passata 2 inizia solo dopo il completamento della Passata 1.
...
| `workers != 1` e file >= 50 | **Parallelo** | `ThreadPoolExecutor` con distribuzione per-file |
