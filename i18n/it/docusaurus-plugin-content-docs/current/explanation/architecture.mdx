...
<div style={{borderRadius:'8px',overflow:'hidden',margin:'1.5rem 0'}}>
  <img src="/assets/brand/svg/zenzic-pipeline-flow.svg" alt="Zenzic — Pipeline a Due Passate: File Set → Passata 1 (Shield + Content stream) → Passata 2 (Cross-Check) → Passata 3 (Integrity Report) → Quality Report" style={{width:'100%',display:'block'}} />
</div>
...
<div style={{borderRadius:'8px',overflow:'hidden',margin:'1.5rem 0'}}>
  <img src="/assets/brand/svg/zenzic-shield-normalization.svg" alt="Zenzic Shield — algoritmo di normalizzazione in 8 passaggi: dalla riga grezza attraverso ZRT-006/007/003 fino alla scansione duale e al SecurityFinding" style={{width:'100%',maxWidth:'560px',display:'block',margin:'1.5rem auto'}} />
</div>
...
<div style={{borderRadius:'8px',overflow:'hidden',margin:'1.5rem 0'}}>
  <img src="/assets/brand/svg/zenzic-vsm-projection.svg" alt="Zenzic Virtual Site Map — proiezione dal filesystem attraverso VSMBuilder e Adapter Protocol verso un catalogo di route con stati REACHABLE, ORPHAN e GHOST" style={{width:'100%',display:'block'}} />
</div>
