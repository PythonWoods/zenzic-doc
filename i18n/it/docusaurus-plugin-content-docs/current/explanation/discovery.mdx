...
| MkDocs (Material) | No                                  | Adesione rinviata fino all'ingresso del plugin `material/blog` nello scope v0.7. |
...
v0.7.x include un comando CLI di prima classe che espone il VSM a consumer esterni:
