...
> Per il riferimento completo all'input `guard-scan` e gli esempi di workflow, vedi [Riferimento Zenzic GitHub Action — Input](../reference/zenzic-action.mdx#inputs).
