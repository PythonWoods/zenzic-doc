...
- [Z201 (Credential Secret)](../reference/finding-codes.mdx#z201)
- [Z202 (Path Traversal)](../reference/finding-codes.mdx#z202)
- [Z203 (Path Traversal Fatal)](../reference/finding-codes.mdx#z203)
- [Z204 (Forbidden Term)](../reference/finding-codes.mdx#z204)

Per firme tecniche, esempi e remediation playbook, usare la
[famiglia Z2xx Security nella Finding Codes Gallery](../reference/finding-codes.mdx#z201).
