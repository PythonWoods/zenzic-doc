...
## Perché "Quartz Clarity" {#naming}

Il quarzo è silice cristallina — formato sotto calore e pressione estremi, perfettamente trasparente
e tra i minerali più duri della Terra. Le civiltà antiche lo usavano per intagliare lenti e
superfici di misura — perché le sue facce erano geometricamente perfette.

Zenzic aspira a essere quarzo: trasparente (deterministico, riproducibile, solo-sorgente), duro
