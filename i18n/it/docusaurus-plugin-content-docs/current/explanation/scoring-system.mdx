...
> Per la tabella completa di lookup penalità per codice, vedi [Algoritmo di Scoring — Tabella di Riferimento delle Penalità](../reference/scoring-algorithm.mdx#penalty-table).
...
> Per il riferimento CLI e i pattern di integrazione CI, vedi [Gestione del Technical Debt](../how-to/handle-technical-debt.mdx) e [Design dello Scoring](./scoring-design.mdx).
