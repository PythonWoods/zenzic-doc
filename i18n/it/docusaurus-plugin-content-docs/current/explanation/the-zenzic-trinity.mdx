...
Zenzic current release è molto più di un linter. È un **Sistema di Conoscenza Sovrano** — un ecosistema
in cui logica, intenzione ed esecuzione sono permanentemente sincronizzati. Per garantire un vero
[Exclusion Zone](./privacy-gate.mdx), Zenzic è organizzato in una Trinità dell'Integrità: tre
...
La cartografia AST a livello repository è disponibile tramite la superficie regole deterministica
e esportata via comandi `zenzic inspect` per l'integrazione del contesto esterno.
