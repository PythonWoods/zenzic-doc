...
![Badge Zenzic Audit](/assets/brand/svg/zenzic-badge-audit.svg)

Usa questo badge per certificare che la documentazione ha superato il controllo di integrità completo di Zenzic: link strutturali, credential scanner (Z201–Z204) e path traversal guard (Z205). È un gate binario: **audit: passed** oppure **audit: failed**.
