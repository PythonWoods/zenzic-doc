...
<div className="flex gap-2 items-baseline"><span className="text-rose-500">✘</span><span className="bg-rose-500/10 text-rose-400 px-1 rounded-sm text-[11px]">[ZZ-NODRAFT]</span><span className="text-zinc-300">docs/guide/install.md:14</span></div>
<div className="text-zinc-500 ml-6 text-[11px]">Rimuovere il marker DRAFT prima della pubblicazione.</div>
