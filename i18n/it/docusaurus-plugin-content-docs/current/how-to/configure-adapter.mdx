...
> Per il riferimento completo ai campi `[build_context]`, le regole di discovery degli adapter e il formato nav di ZensicalAdapter, vedi [Configuration Reference — `[build_context]`](../reference/configuration-reference.mdx#build-context).
