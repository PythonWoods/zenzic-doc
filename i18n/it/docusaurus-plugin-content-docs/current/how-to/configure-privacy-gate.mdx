...
[Riferimento Configurazione](../reference/configuration-reference.mdx) per la specifica
...
- [Esempio Z204](https://github.com/PythonWoods/zenzic/tree/main/examples/rules/z204-privacy-gate) — dimostrazione eseguibile
