...
Il costo **scala** non appena superi il cap: ogni soppressione oltre 30 costa **2 pt** invece di 1.
...
L'escalation è intenzionale: accumulare soppressioni oltre il cap di governance è un segnale
che il progetto ha un debito documentale strutturale che non può essere mascherato.
