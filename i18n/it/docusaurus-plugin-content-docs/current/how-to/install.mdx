...
testo semplice. **Non esegue** il motore di build né i suoi plugin.
...
- [Funzionalità avanzate](../reference/advanced-features.mdx) — integrità dei riferimenti, Shield, utilizzo programmatico
