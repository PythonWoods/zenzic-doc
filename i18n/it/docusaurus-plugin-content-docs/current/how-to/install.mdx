...
Puoi anche fissare una versione specifica tramite tag:

```bash
uvx --from git+https://github.com/PythonWoods/zenzic@v0.10.0 zenzic .
```
...
> Per il razionale di design completo dietro la modalità engine-aware rispetto a standalone, vedi [Architettura — Sovereign CLI](../explanation/architecture.mdx#sovereign-cli).
