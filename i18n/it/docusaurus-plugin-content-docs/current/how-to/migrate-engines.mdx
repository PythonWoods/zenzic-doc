...
> Per il razionale architetturale — perché Zenzic analizza i sorgenti e non il build, come MkDocsAdapter preserva il contratto strutturale e come l'i18n viene validato indipendentemente dal rendering — vedi [Design della Migrazione dei Motori](../explanation/engine-migration-design.mdx).
