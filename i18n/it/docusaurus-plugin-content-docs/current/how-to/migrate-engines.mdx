...
Questo è il Exclusion Zone: **uno strato di validazione fisso che rimane valido
...
Per un benchmark pratico usa il fixture della galleria Z-code `examples/z101-broken-links/`, che isola
le violazioni di integrità dei link e mostra come i pattern nav di MkDocs interagiscono con il link checker di Zenzic.
