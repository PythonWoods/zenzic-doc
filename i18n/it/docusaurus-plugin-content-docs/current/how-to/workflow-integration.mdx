...
<ZenzicTerminal title="zenzic check all"><span className="text-rose-500">✘</span>{" "}<span className="bg-rose-500/10 text-rose-400 px-1 rounded-sm text-[11px]">[Z301]</span>{" "}<span className="text-zinc-300">DANGLING_REF — exit 1</span></ZenzicTerminal>
...
- [Sistema di Scoring](../explanation/scoring-system.mdx) — come Zenzic calcola il
