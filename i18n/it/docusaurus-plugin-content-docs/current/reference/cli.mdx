...
zenzic check all --ci               # Shorthand CI: imposta --strict e --format github-annotations
...
`--ci` è un comodo shorthand progettato specificamente per le pipeline GitHub Actions. Forza due comportamenti simultaneamente:
