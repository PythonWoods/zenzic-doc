...
Zenzic esclude automaticamente certi file da tutti i controlli di qualità — incluso il controllo asset non utilizzati (Z903). Queste **Protezioni di Livello 1** sono immutabili e non richiedono alcuna configurazione utente.
...
Z903 su `docusaurus.config.ts`, `package.json` o qualsiasi altro file di configurazione del motore.
:::
