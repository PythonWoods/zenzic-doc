...
- Gli asset referenziati **solo** da un post non producono più Z903 (Asset Inutilizzato).
...
consumata da tool esterni: script Bash custom, dashboard di CI/CD, o agenti di
Intelligenza Artificiale che necessitano di contesto architetturale.
:::
