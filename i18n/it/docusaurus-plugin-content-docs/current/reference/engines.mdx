...
Zenzic include adapter per specifiche linee di versione maggiore. Dichiarare un motore diverso è un errore di configurazione: Zenzic emetterà `Z001 CONFIG_ERROR` e si interromperà.
