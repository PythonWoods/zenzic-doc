...
Vedi [Politica di Soppressione](./suppression-policy.mdx) per il riferimento completo.
:::
...
**Severità:** `error` · **Penalità:** −8,0 pt (Strutturale) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z1xx-links/z101-broken-links)
...
**Severità:** `error` · **Penalità:** −5,0 pt (Strutturale) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z1xx-links/z102-anchor-missing)
...
**Severità:** `error` · **Penalità:** 0,0 pt · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z1xx-links/z103-orphan-link)
...
**Severità:** `error` · **Penalità:** −2,0 pt (Strutturale) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z1xx-links/z105-absolute-path)
...
**Severità:** `error` · **Penalità:** −1,0 pt (Strutturale) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z1xx-links/z108-empty-link-text)
...
`zenzic:ignore: Z201` è **silenziosamente rifiutato**. Il credential scanner si attiva incondizionatamente su ogni riga. [↗ Gallery](../how-to/examples/z2xx-security/z201-credentials)
:::
...
`zenzic:ignore: Z202` è **silenziosamente rifiutato**. [↗ Gallery](../how-to/examples/z2xx-security/z202-path-traversal)
:::
...
:::danger[🔒 INVIOLABILE — Non sopprimibile | Uscita 2 | DQS collassa a 0/100]
`zenzic:ignore: Z204` è **silenziosamente rifiutato**. Sorgente: `forbidden_patterns` in `.zenzic.local.toml` (ignorato da git). [↗ Gallery](../how-to/examples/z2xx-security/z204-forbidden-term)
:::
...
**Severità:** `error` · **Penalità:** −4,0 pt (Navigazione) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z3xx-references/z301-dangling-ref)
...
**Severità:** `warning` · **Penalità:** −1,0 pt (Navigazione) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z3xx-references/z302-dead-def)
...
**Severità:** `warning` · **Penalità:** −3,0 pt (Navigazione) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z3xx-references/z303-duplicate-def)
...
**Severità:** `warning` · **Penalità:** −4,0 pt (Navigazione) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z4xx-topology/z402-orphan-page)
...
**Severità:** `warning` · **Penalità:** nessuna (avviso di accessibilità) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z4xx-topology/z403-missing-alt)
...
**Severità:** `warning` · **Penalità:** −2,0 pt (Contenuto) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z5xx-content/z501-placeholder)
...
**Severità:** `warning` · **Penalità:** −1,0 pt (Contenuto) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z5xx-content/z502-short-content)
...
**Severità:** `error` · **Penalità:** −10,0 pt (Contenuto — penalità massima per occorrenza singola) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z5xx-content/z503-snippet-error)
...
**Severità:** `warning` · **Penalità:** −1,0 pt (Contenuto) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z5xx-content/z505-untagged-code-block)
...
**Severità:** `warning` · **Penalità:** −2,0 pt (Governance) + Escalation · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z6xx-brand/z601-brand-obsolescence)
...
**Severità:** `warning` · **Penalità:** nessuna (controllo integrità bilingue) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z6xx-brand/z602-i18n-parity)
...
Zenzic supporta la **soppressione per riga e per codice** tramite commenti inline. Aggiungi un commento `zenzic:ignore` alla fine di qualsiasi riga per silenziare un diagnostico specifico solo per quella riga.

Per file `.md`, usa un commento HTML standard (invisibile nel Markdown renderizzato):

```markdown
L'era Obsidian ha definito le nostre fondamenta. <!-- zenzic:ignore: Z601 -->
```

Per file `.mdx`, usa un commento JSX (invisibile nel MDX renderizzato, sicuro per Docusaurus/React):

```mdx
L'era Obsidian ha definito le nostre fondamenta. {/* zenzic:ignore: Z601 */}
```

Ogni commento di soppressione silenzia **solo** il codice specificato su quella riga. Per sopprimere più codici, aggiungi più commenti. Per esentare un intero file, usa `obsolete_names_exclude_patterns` (Z601) o i pattern `excluded_files` rilevanti in `.zenzic.toml`.

:::tip[Usa la soppressione con parsimonia]
La soppressione è per decisioni intenzionali e documentate — non per silenziare rilevamenti non revisionati. Ogni riga soppressa dovrebbe avere un commento corrispondente che spieghi il perché.
:::

Vedi [Politica di Soppressione](./suppression-policy.mdx) per il riferimento completo, inclusa la modalità `--strict`, il modello Suppression Debt e l'override `--audit`.
