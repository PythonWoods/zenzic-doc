...
**Severità:** `error` · **Penalità:** −3,0 pt (Strutturale) · **Uscita:** 1 · **Sopprimibile:** Sì · [↗ Gallery](../how-to/examples/z1xx-links/z109-external-link-broken)
...
> Vedi [Politica di Soppressione](./suppression-policy.mdx) per la sintassi inline (`zenzic:ignore`), il modello Suppression Debt e l'override `--audit`.
