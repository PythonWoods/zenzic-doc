...
L'architettura fondamentale di Zenzic. La prima passata raccoglie i riferimenti, scansiona lo Shield e costruisce la ReferenceMap. La seconda passata valida i link, risolve i percorsi e verifica le ancore. Questa separazione garantisce che la cross-check dei riferimenti avvenga solo dopo che tutte le definizioni sono state raccolte, e che lo Shield abbia la priorità assoluta. Vedi [Architettura -- Pipeline a Due Passate](../explanation/architecture#two-pass-pipeline).
