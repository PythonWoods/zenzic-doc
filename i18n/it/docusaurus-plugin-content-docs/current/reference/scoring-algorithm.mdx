...
Ogni soppressione attiva è un'assunzione consapevole di responsabilità. Le soppressioni sono allowance-based: fino a `suppression_cap` sono debito autorizzato di governance e non riducono il punteggio. Solo le soppressioni oltre cap generano debito.
