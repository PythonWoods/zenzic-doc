...
Le soppressioni entro `suppression_cap` sono allowance-based. Ogni soppressione deduce 1 punto (modello flat-cost). `suppression_cap` è ora esclusivamente una soglia di hard-fail per l'exit code. I progetti con soppressioni attive vedranno il punteggio massimo raggiungibile ridotto del numero di soppressioni.
:::
