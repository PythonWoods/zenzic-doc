...
| **Critical Debt** | n > CAP | `[CRITICAL DEBT]` (rosso) | 🚨 Errore | Le soppressioni superano il cap duro. Il gate di CI fallirà (exit code 2). La bonifica è obbligatoria. |
...
Se `suppression_cap` è omesso, Zenzic usa un default built-in di **50**.
