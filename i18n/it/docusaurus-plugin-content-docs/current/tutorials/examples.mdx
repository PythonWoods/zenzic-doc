...
description: Un indice ragionato dei progetti di riferimento Zenzic — da Standalone Mode zero-config a VCS-aware, integrazione MkDocs, adapter Docusaurus e security lab Shield.
---
...
**Motore:** `mkdocs`
<SentinelOutput status="error" exitCode={1} compact />
