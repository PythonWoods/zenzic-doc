...
**Lo Scudo (Sigillo della Sentinella)** — ora esegui l'atto 0:

```bash
uvx zenzic lab 0
```

Vedrai il Sigillo della Sentinella: ogni controllo verde, exit 0. Il contrasto è la lezione —
...
path traversal e il Sigillo della Sentinella. Zero installazione. Zero configurazione. Esperienza pura.
...
Un'esecuzione pulita si presenta così — il **Sigillo della Sentinella**:
