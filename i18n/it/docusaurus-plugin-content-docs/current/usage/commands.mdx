...
tutti gli adapter (MkDocs e Zensical) a risolvere gli URL **senza** `use_directory_urls`,
producendo percorsi `.html` piatti invece di slug clean basati su directory.
...
Il flag `--offline` ha un **comportamento identico** su entrambi gli adapter MkDocs e Zensical.
