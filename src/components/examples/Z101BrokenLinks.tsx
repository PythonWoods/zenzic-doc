    ...
    <ZenzicTerminal title="zenzic check links">
      ...
      <div className="flex gap-3 mb-4">
        ...
        <span className="text-zinc-300">
          &apos;missing.md&apos; not found in docs
        </span>
      </div>
      <div className="h-2" />
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">9</span>│ ## Broken References</div>
      ...
      <div className="text-zinc-300 flex bg-zinc-800/30 -mx-6 px-6 py-0.5">
        ...
        <span>- [Getting Started](missing.md) — this file does not exist → **Z101**</span>
      </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3"> </span>│ <span className="text-rose-500">^^^^^^^^^^^^^^^^^^^^^^^^^^^^^</span></div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">12</span>│ - [Setup Guide](guide/setup.md) — this directory does not exist → </div>
      <div className="text-zinc-400">**Z101**</div>
      ...
      <div className="flex gap-3 mb-4">
        ...
        <span className="text-zinc-300">
          &apos;guide/setup.md&apos; not found in docs
        </span>
      </div>
      <div className="h-2" />
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">10</span>│ </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">11</span>│ - [Getting Started](missing.md) — this file does not exist → **Z101**</div>
      <div className="text-zinc-300 flex bg-zinc-800/30 -mx-6 px-6 py-0.5">
        <span className="w-6 text-right mr-3 text-rose-500 font-bold">12</span>
        <span className="text-rose-500 mr-1 font-bold">❱</span>
        <span>- [Setup Guide](guide/setup.md) — this directory does not exist → </span>
      </div>
      <div className="text-zinc-400">**Z101**</div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3"> </span>│ <span className="text-rose-500">^^^^^^^^^^^^^^^^^^^^^^^^^^^^^</span></div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">13</span>│ </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">14</span>│ ## What Zenzic Reports</div>
      <div className="h-2" />
      <div className="text-zinc-700 my-4 select-none">────────────────────────────────────────────────────────────────────────────────</div>
      <div className="h-2" />
      <div className="flex flex-wrap gap-4 mt-4">
        Summary:
        <span className="text-rose-500 font-medium">✘ 2 errors</span>
