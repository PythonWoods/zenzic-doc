...
export default function Z109ExternalLinkBroken(): React.JSX.Element {
  // REUSE-IgnoreStart
  return (
    <ZenzicTerminal title="zenzic check links">
      ...
      <div className="flex gap-3 mb-4">
        ...
        <span className="text-zinc-300">
          external link &apos;https://this-domain-does-not-exist-at-all-xyz.com&apos; is broken
        </span>
      </div>
      <div className="h-2" />
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">5</span>│ </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">6</span>│ Here is a broken external link:</div>
      <div className="text-zinc-300 flex bg-zinc-800/30 -mx-6 px-6 py-0.5">
        <span className="w-6 text-right mr-3 text-rose-500 font-bold">7</span>
        <span className="text-rose-500 mr-1 font-bold">❱</span>
        <span>- [Broken Link](https://this-domain-does-not-exist-at-all-xyz.com)</span>
      </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3"> </span>│   <span className="text-rose-500">^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^</span></div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">8</span>│ </div>
      <div className="h-2" />
      ...
      <div className="flex flex-wrap gap-4 mt-4">
        ...
        <span className="text-zinc-500 font-medium">⚠ 0 warnings</span>
