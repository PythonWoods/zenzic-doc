...
export default function Z301DanglingRef(): React.JSX.Element {
  return (
    <ZenzicTerminal>
      ...
      <div className="flex gap-3 mb-4">
        ...
        <span className="text-zinc-300">
          Reference &apos;[Click here][missing-ref]&apos; uses undefined ID &apos;missing-ref&apos;.
        </span>
      </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">10</span>│ ## Content With Dangling Reference</div>
      ...
      <div className="text-zinc-300 flex bg-zinc-800/30 -mx-6 px-6 py-0.5">
        ...
        <span>To get started, [Click here][missing-ref] for the installation guide.</span>
      </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">13</span>│ </div>
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">14</span>│ Note: `missing-ref` has no corresponding `[missing-ref]: url` definition</div>
