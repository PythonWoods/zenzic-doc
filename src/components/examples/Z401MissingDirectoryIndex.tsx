...
export default function Z401MissingDirectoryIndex(): React.JSX.Element {
  // REUSE-IgnoreStart
  return (
    <ZenzicTerminal title="zenzic check all --show-info">
      <div className="text-zinc-500 mb-4">zensical - 1 file (1 docs, 0 assets) - 0.0s - 68 files/s</div>
      <div className="h-2" />
      ...
      <div className="flex gap-3 mb-4">
        ...
        <span className="bg-zinc-500/10 text-zinc-400 px-1.5 py-0.5 rounded-sm whitespace-nowrap">
          [Z401]
        </span>
      ...
      <div className="flex flex-wrap gap-4 mt-4">
        ...
        <span className="text-zinc-400 font-medium">💡 1 info</span>
