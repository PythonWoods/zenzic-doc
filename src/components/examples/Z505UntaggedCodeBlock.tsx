...
export default function Z505UntaggedCodeBlock(): React.JSX.Element {
  // REUSE-IgnoreStart
  return (
    <ZenzicTerminal title="zenzic check all">
      <div className="text-zinc-500 mb-4">standalone - 1 file (1 docs, 0 assets) - 0.0s - 61 files/s</div>
      <div className="h-2" />
      ...
      <div className="flex gap-3 mb-4">
        ...
        <span className="text-zinc-300">
          Fenced code block has no language specifier. Add a
        </span>
      </div>
      <div className="text-zinc-400">language tag (e.g. ```python, ```bash, ```toml) to enable syntax highlighting </div>
      <div className="text-zinc-400">and snippet validation.</div>
      <div className="h-2" />
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">11</span>│ Run the following command to get started:</div>
      ...
      <div className="text-zinc-300 flex bg-zinc-800/30 -mx-6 px-6 py-0.5">
        <span className="w-6 text-right mr-3 text-rose-500 font-bold">13</span>
      ...
      <div className="text-zinc-600 flex"><span className="w-6 text-right mr-3">14</span>│ zenzic check all --fail-under 0</div>
